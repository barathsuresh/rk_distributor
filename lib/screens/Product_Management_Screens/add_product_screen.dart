                    ...
                    return Row(
                      children: [
                          ...
                          child: Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              value: productController
                                      .areaPrices[index].name.isEmpty
                                  ? null
                                  : productController.areaPrices[index].name,
                              hint: Text('Select Area'),
                              items: customerService.areaList
                                  .map((String value) {
                              ...
                              onChanged: (value) {
                                if (value != null) {
                                  productController.areaPrices[index] =
                                      AreaPrice(
                                          name: value,
                        ...
                        IconButton(
                          ...
                          onPressed: () =>
                              productController.removeAreaPrice(index),
                        ),
                      ],
                    );
                  },
                      ...
                      children: [
                        Expanded(
                          ...
                          child: Container(
                            width: MediaQuery.of(context).size.width / 2,
                            child: DropdownButton<String>(
                              value: productController.customerPrices[index]
                                      .customerId.isEmpty
                                  ? null
                                  : productController
                ...
                child: FilledButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (!hasDuplicateAreaPrices(
                          productController.areaPrices)) {
                        ...
                        if (!hasDuplicateCustomerPrices(
                          ...
                          ShowSnackBar.showSnackBar(
                              title: "Error",
                              msg:
                                  "Duplicate customer prices are not allowed");
                        }
                      } else {
