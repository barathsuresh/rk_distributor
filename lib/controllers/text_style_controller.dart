...
class TextStyleController extends GetxController {
  ...
  void initializeTextStyles() {
    ...
    listTileTextMainStyle.value =
        GoogleFonts.sourceCodePro(color: Colors.black, fontSize: 20,fontWeight: FontWeight.bold);
    listTileTextSubtitleStyle.value = GoogleFonts.sourceCodePro(color: Colors.black);
    nothingToBeDisplayedStyle.value = GoogleFonts.roboto(color: textColor);
    userListTileTitleStyle.value = GoogleFonts.archivoBlack(color: Colors.black,fontSize: 20);
